                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span>Se realizo desembolso a la operacion crediticia de Carla</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        Juan Carlos tiene una atraso de pago desde 17/05/2021, Se le realizo un arreglo de pago
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        ...
                                        Se ha realizado un telegrama al asociado Daniel || Motivo: Retraso en su respectivo cargo
                                    </div>
                                </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="header__nav__widget">
                                <a href="{{route('login')}}" class="btn btn-dark mt-3">Login</a>
                            </div>
                        @else
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Proyecto Final Siquirres</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
